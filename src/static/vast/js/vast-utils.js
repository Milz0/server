    ...
    const VastUtils = {
        ...
        getOfferBadges: function (offer) {
            ...
            if (verification === 'verified') {
                badges += '<span class="badge badge-success badge-pill mr-1" title="Verified Host">';
                badges += '<i class="fas fa-check-circle"></i> Verified';
                badges += '</span>';
            } else if (verification === 'deverified') {
                badges += '<span class="badge badge-danger badge-pill mr-1" title="Deverified - Was verified but no longer meets requirements">';
                badges += '<i class="fas fa-times-circle"></i> Deverified';
                badges += '</span>';
            } else {
                badges += '<span class="badge badge-secondary badge-pill mr-1" title="Unverified Host">';
                badges += '<i class="fas fa-question-circle"></i> Unverified';
                badges += '</span>';
            }

            if (offer.hosting_type === 1) {
                badges += '<span class="badge badge-primary badge-pill mr-1" title="Datacenter">';
            ...
            if (offer.reliability2 !== undefined && offer.reliability2 !== null) {
                ...
                badges += '<span class="badge badge-' + reliabilityClass + ' badge-pill mr-1" title="Reliability: ' + reliabilityPct + '%">';
        ...
        getInstanceTypeBadge: function (instance) {
            if (instance.intended_status === 'running') {
                return '<span class="badge badge-success badge-pill" title="On-Demand Instance"><i class="fas fa-server"></i> On-Demand</span>';
            } else if (instance.intended_status === 'stopped') {
                return '<span class="badge badge-warning badge-pill" title="Bid Instance"><i class="fas fa-gavel"></i> Bid</span>';
            } else {
                return '<span class="badge badge-secondary badge-pill" title="Unknown Type"><i class="fas fa-question"></i> Unknown</span>';
            }
        },
