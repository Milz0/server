...
(function () {
    ...
    const VastInstances = {
        ...
        displayInstances: function (instances) {
            ...
            html += '<th style="width: 60px;"><i class="fas fa-hashtag me-1"></i>ID</th>';
            html += '<th><i class="fas fa-info-circle me-1"></i>Status Message</th>';
            html += '<th><i class="fas fa-microchip me-1"></i>GPU</th>';
            html += '<th class="text-center" style="width: 120px;"><i class="fas fa-heartbeat me-1"></i>Status</th>';
            html += '<th class="text-center" style="width: 140px;"><i class="fas fa-dollar-sign me-1"></i>Cost</th>';
            html += '<th><i class="fas fa-map-marker-alt me-1"></i>Location</th>';
            html += '<th class="text-center" style="width: 100px;"><i class="fas fa-clock me-1"></i>Uptime</th>';
            ...
            instances.forEach(function (instance) {
                ...
                html += '<span class="badge bg-' + statusBadge.class + '">';
        ...
        updateInstanceCountBadge: function (count) {
            ...
            badge.removeClass('bg-secondary bg-success bg-primary bg-warning bg-danger');
        ...
        updateBalanceDisplay: function () {
            ...
            if (hourlyCost > 0 && balance > 0) {
                ...
                if (hoursRemaining < 1) {
                    ...
                    runtimeText = '<span class="text-danger fw-bold">' + minutes + ' minutes</span>';
                    ...
                    runtimeText = '<span class="text-warning fw-bold">' + hoursRemaining.toFixed(1) + ' hours</span>';
                    ...
                    runtimeText = '<span class="text-success fw-bold">' + days + 'd ' + hours + 'h</span>';
                ...
                $('#runtimeEstimate').html('<span class="text-danger fw-bold">Insufficient funds</span>');
        ...
        init: function () {
            $('#loadInstancesBtn').off('click').on('click', function () {
                const loadPromise = VastAPI.loadInstances(false);

                if (loadPromise && loadPromise.done) {
                    loadPromise.done(function () {
                        VastApp.showNotification('success', 'Instances Refreshed', 'Latest data loaded');
                    }).fail(function () {
                        // Error is already shown by VastAPI
                    });
                }
            });
        }
