...
(function () {
    ...
    window.VastNotifications = {
                ...
                $('#vast-status').before(`
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <button id="vast-notification-toggle" class="btn btn-sm btn-outline-secondary">
                            <i class="fas fa-bell"></i> Notifications <span id="notification-badge" class="badge badge-danger" style="display: none;">0</span>
                        </button>
                    </div>
                `);
            }
        ...
        createNotificationCenterModal: function () {
            return `
                <div class="modal fade" id="notificationCenterModal" tabindex="-1" role="dialog">
